    ...
    async function exploreUrls(baseUrl, currentUrl, depth, wantedDepth) {
        ...
        if (await isUrlValid(currentUrl)) {
            ...
            if (!currentUrl.endsWith('.pdf')) {
                ...
                fs.writeFileSync(`output/${folder}/complete_html.html`, html);
                ...
                fs.writeFileSync(`output/${folder}/page_html.jsonl`, JSON.stringify(page_html, null, 2));
                ...
                fs.writeFileSync(`output/${folder}/parents.jsonl`, JSON.stringify(parents, null, 2));
                ...
                fs.writeFileSync(`output/${folder}/markdown.md`, markdown);
                ...
                if (!fs.existsSync(`output/${folder}/images`)) {
                    ...
                    fs.rmdirSync(`output/${folder}/images`, { recursive: true });
                    fs.mkdirSync(`output/${folder}/images`, { recursive: true });
                }
